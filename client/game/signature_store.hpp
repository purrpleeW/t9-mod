...
namespace Client {
	class SignatureStore {
		...
		public:
			...
			void Scan(const std::string& moduleName) const {
				Res scTemp = Memory::SigScan(this->m_Signature, moduleName, this->m_Name);
	...
	public:
		SignatureStore(const std::string& moduleName)
			: m_Module(moduleName)
		{}

		SignatureStore()
			: SignatureStore(Common::Utility::NT::Library().GetName())
		{}
